...
extern void iris_transformer_free_mmap_cache(iris_transformer_t *tf);
...
extern float *iris_transformer_forward_with_refs(iris_transformer_t *tf,
                                                 const float *img_latent, int img_h, int img_w,
...
extern float *iris_transformer_forward_with_multi_refs(iris_transformer_t *tf,
                                                       const float *img_latent, int img_h, int img_w,
...
float *iris_sample_euler(void *transformer, void *text_encoder,
...
float *iris_sample_euler_with_refs(void *transformer, void *text_encoder,
                                   float *z, int batch, int channels, int h, int w,
                                   const float *ref_latent, int ref_h, int ref_w,
                                   int t_offset,
                                   const float *text_emb, int text_seq,
 ...
 */
float *iris_sample_euler_with_multi_refs(void *transformer, void *text_encoder,
                                         float *z, int batch, int channels, int h, int w,
                                         const iris_ref_t *refs, int num_refs,
                                         const float *text_emb, int text_seq,
                                         const float *schedule, int num_steps,
...
float *iris_sample_euler_cfg(void *transformer, void *text_encoder,
                              float *z, int batch, int channels, int h, int w,
 ...
 */
float *iris_sample_euler_cfg_with_refs(void *transformer, void *text_encoder,
                                        float *z, int batch, int channels, int h, int w,
                                        const float *ref_latent, int ref_h, int ref_w,
                                        int t_offset,
                                        const float *text_emb_cond, int text_seq_cond,
 ...
 */
float *iris_sample_euler_cfg_with_multi_refs(void *transformer, void *text_encoder,
                                              float *z, int batch, int channels, int h, int w,
                                              const iris_ref_t *refs, int num_refs,
                                              const float *text_emb_cond, int text_seq_cond,
                                              const float *text_emb_uncond, int text_seq_uncond,
...
float *iris_generate_latent(void *ctx_ptr,
    ...
    float *schedule = iris_linear_schedule(num_steps);

    /* Sample (FLUX.2-klein is guidance-distilled, no CFG needed) */
    float *latent = iris_sample_euler(ctx_ptr, NULL,
