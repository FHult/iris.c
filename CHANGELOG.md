...
## Open-weight SREF releases (2026-07-21)

Two style-reference weight releases, both MIT, both needing the Flux.2 Klein 4B **base** (Apache 2.0)
and the CSD-ViT-L reference encoder (CC-BY-4.0):
- **[sref-adapter-v1](https://github.com/FHult/iris.c/releases/tag/sref-adapter-v1)** — the generic
  Learned Style adapter (`joint_lora` + `csd_mod`); transfers *any* reference's style.
- **[style-library-v1](https://github.com/FHult/iris.c/releases/tag/style-library-v1)** — a 3-style
  retrieval pack (cyberpunk / fantasy portrait / graphic) + a portable `library.json`.
